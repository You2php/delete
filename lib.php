...
function html5_player($id){
    ...
    if(count($links)!=1){
        ...
        echo '<source src="./downvideo.php?v='.$id.'&quality=720P&format=mp4" type=\'video/mp4\' res="720" label=\'720P\'/>';   
            };
        echo '<source src="./downvideo.php?v='.$id.'&quality=360P&format=mp4" type=\'video/mp4\' res="360" label=\'360P\'/>';
